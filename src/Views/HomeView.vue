  ...
  <div class="home-page">
    ...
    <!-- <section class="mt-5 my-5 position-relative pt-5 d-none d-md-block">
            ...
            <div class="card position-relative z-10 col-10 mx-auto pb-4 d-flex flex-wrap justify-content-lg-between justify-content-center">
                <img src="../../public/images/10Days.png" class="card-image" alt="">
                <div class="price-overlay">
        ...
        <section class="mb-5 d-none d-md-block">
            <div class="d-flex flex-wrap my-5 col-10 mx-auto mt-5">
                <div class="col-lg-4 col-md-6 px-3 mt-5">
                    <div class="card position-relative pb-4">
                    <img src="../../public/images/8Days.png" class="card-image" alt="">
                    <div class="price-overlay">
                ...
                <div class="col-lg-4 col-md-6 px-3 mt-5">
                    <div class="card position-relative pb-4">
                    <img src="../../public/images/12Days.png" class="card-image" alt="">
                    <div class="price-overlay">
                ...
                <div class="col-lg-4 col-md-6 px-3 mt-5">
                    <div class="card position-relative pb-4">
                    <img src="../../public/images/12Days-azrabegan.png" class="card-image" alt="">
                    <div class="price-overlay">
                ...
                <div class="col-lg-4 col-md-6 px-3 mt-5">
                    <div class="card position-relative pb-4">
                    <img src="../../public/images/10Days-azrabegan.png" class="card-image" alt="">
                    <div class="price-overlay">
                ...
                <div class="col-lg-4 col-md-6 px-3 mt-5">
                    <div class="card position-relative pb-4">
                    <img src="../../public/images/8Days-azrabegan.png" class="card-image" alt="">
                    <div class="price-overlay">
