    ...
    <footer>
        <section class="col-10 mx-auto my-3">
            <div class="d-flex flex-wrap align-items-center justify-content-lg-between justify-center">
                <div class="col-3 mt-lg-0 my-2"><img src="../assets/Images/WEBSITE DESIGN/logo.png" class="footer-image" alt=""></div>
        ...
        <section class="d-flex flex-wrap col-10 mx-auto my-5">
            ...
            <div class="col-lg-4 col-md-6 text-center">
                ...
                <h3 class="text-2xl font-bold main-color mb-4 text-gray-800">{{ $t('home.sec9.gorg.tit') }}</h3>
